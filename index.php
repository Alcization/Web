...
<div style="display:flex;gap:10px;flex-wrap:wrap;margin-top:18px">
  ...
  <button class="btn btn-ghost1" onclick="location.href='/accounts.php'">View Accounts</button>
  <button class="btn btn-ghost1" onclick="location.href='/transfer.php'">Transfer (Demo)</button>
